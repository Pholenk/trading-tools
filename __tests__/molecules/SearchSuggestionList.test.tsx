...
describe('PageHeader', () => {
  ...
  it('renders the placeholder text', () => {
    ...
    expect(screen.getByPlaceholderText('ASII, ADMR, BBCA...')).toBeInTheDocument()
  })
  ...
  it('renders with a controlled search value', () => {
    ...
    expect((screen.getByRole('textbox') as HTMLInputElement).value).toBe('ASII')
  })
  ...
  it('respects controlled activeTab', () => {
    render(<PageHeader tabs={TABS} activeTab='Calculator' onTabChange={jest.fn()} />)
  ...
  it('respects defaultActiveTab in uncontrolled mode', () => {
    ...
    expect(screen.getByRole('tab', { name: 'Wave' })).toHaveAttribute('aria-selected', 'true')
  })
  ...
  it('applies custom className to the root element', () => {
    const { container } = render(<PageHeader tabs={TABS} className='custom-header' />)
